...
function startApp() {
  ...
  for(var i = 0; i < places.length; i++) {
    ...
    if (userOptions.role === "admin" || userOptions.role === "vendor" || places[i].status === "sold") {
      ...
      popup = places[i].status === 'sold' ? '<div class="popup"><img src="http://electricon.com.mx/mapa_interactivo/lib/proveedores/' + places[i].client + '.png" alt="' + places[i].client + '"></div>' : popup;
    } else {
